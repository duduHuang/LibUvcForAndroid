...
int LIBUSB_CALL libusb_init_context(libusb_context **context, const char *usbfs,
...
libusb_device *libusb_find_device(libusb_context *ctx,
                                  const int vid, const int pid, const char *sn,
                                  int fd);    // XXX add for mainly non-rooted Android
...
int LIBUSB_CALL
libusb_set_device_fd(libusb_device *dev, int fd);    // XXX add for mainly non-rooted Android
